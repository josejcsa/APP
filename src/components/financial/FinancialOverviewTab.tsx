...
interface FinancialOverviewTabProps {
  ...
  expenseItems: ExpenseSupplyItem[];
  onRefresh: () => void;
}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-bold text-slate-900 tracking-tight">Painel Geral & Planilha Google Sheets</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">
            Valores consolidados dos checklists técnicos com apuração de faturamento, comissões e lucro líquido.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3.5">
        ...
        <div className="bg-white p-4.5 rounded-2xl border border-slate-200 shadow-xs space-y-1">
          ...
          <span className="text-[11px] text-slate-400">Água pura, insumos químicos</span>
        </div>
            ...
            <form onSubmit={handleSaveItem} className="space-y-3 text-xs">
              ...
              <div className="flex justify-end space-x-2 pt-2 border-t border-slate-100">
                <button
                  ...
                  className="px-3 py-1.5 border border-slate-200 rounded-xl text-slate-600 hover:bg-slate-50 font-medium cursor-pointer"
                >
                  Cancelar
                </button>
                <button
